...
All course assignments are assigned and evaluated using the GitHub platform. I will only assess work correctly deposited there. Though the previous set of statements implies the following, I state it explicitly here to avoid misunderstanding: I _will only_ grade work that appears on the course GitHub.
